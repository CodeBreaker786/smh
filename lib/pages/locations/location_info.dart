...
class LocationInfo {
  List<LocationItem> locationitems = [
    ...
    LocationItem(
      ...
      description: 'Mental health assessments, inpatient programs for short-term, intensive psychiatric treatment for adults, adolescents and children',
    ),
    LocationItem(
      ...
      description: '24/7 Emergency Care, outpatient radiology, laboratory and rehabilitation services, CardioPulmonary Rehabilitation, primary and speciality care physician offices',
    ),
    LocationItem(
      ...
      description: 'Outpatient services including Radiology/Imaging Services, Full-service Lab Testing/Bloodwork, Rehabilitation Services, Anticoagulation Clinic, Primary, Specialty, Pediatrics & Family Care.',
    ),
    LocationItem(
      ...
      latitude:  27.3872792, 
      longitude:  -82.4654344,
      description: 'Fast treatment for non-life-threatening illnesses and injuries for patients older than 3 months, onsite imaging and laboratory tests, flu shots, other immunizations and student/sports physicals. \nAdditional services at this location include Radiology/Imaging Services, Full-service Lab Testing/Bloodwork, Rehabilitation Services, Anticoagulation Clinic, Primary, Specialty, Pediatrics & Family Care.',
    ),
    LocationItem(
    ...
    LocationItem(
      ...
      latitude:  27.2683725,
      longitude:  -82.462016,
      description: 'Region\'s only medically integrated fitness center, offering a higher level of safety and programs focused on disease prevention, nutrition and weight loss, strength and balance, rehabilitation, and wellness.',
    ),
    LocationItem(
      ...
      description: 'Outpatient services including Neuroscience Center of Excellence, Radiology Services, Full-service Laboratory Testing, Rehabilitation & Specialty Care, HealthFit – Powered by Sarasota Memorial, Primary, Pediatric & Family Care, Bariatric & Metabolic Health Center, Anticoagulation Clinic.',
    ),
    LocationItem(
      ...
      description: 'Short-term and Long-term Inpatient Rehabilitation, Daily Physical, Occupational and Speech, Therapies, 24-hour Nursing Care, Respiratory Therapies (24/7) and Pulmonary Conditioning.',
    ),
    LocationItem(
    ...
    LocationItem(
      ...
      description: 'Outpatient services including Radiology/Imaging Services, Full-service Laboratory Testing, Primary, Specialty, Pediatrics & Family Care, Diabetes Treatment Services, Anticoagulation Clinic, Heart Failure Clinic.',
    ),
    LocationItem(
      ...
      description: 'Outpatient services including Radiology/Imaging Services, Full-service Lab Testing, Primary, Specialty, Pediatrics & Family Care.\nUrgent Care Center at this location with fast treatment for non-life-threatening illnesses and injuries for patients older than 3 months, onsite imaging and laboratory tests, flu shots, other immunizations and student/sports physicals.',
    ),
    LocationItem(
    ...
    LocationItem(
      title: 'Home Care',
      address: '6075 Rand Blvd. Suite 3,\nSarasota, FL 34239',
      image: 'assets/images/HomeCare.jpg',
      mapAddress:  '6075+Rand+Blvd+Suite+3+Sarasota+FL+34239',
      url: '9419177730',
      latitude:27.0560097,
      longitude: 12.9,
      description: 'In-home skilled nursing care, rehabilitation therapy and personal care for patients recovering at home from an operation, illness, injury or medical condition.',
    ),
    LocationItem(
      ...
      latitude:  27.0560097,
      longitude: 12.9,
      description: 'Outpatient APPOINTMENTS ARE BY REFERRAL ONLY Sarasota Memorial\'s Community Specialty Clinic (CSC) provides specialty medical care and referral services to Sarasota County residents who are uninsured or underinsured, who demonstrate a true financial need, and who are age 18 or older',
    ),
    LocationItem(
      ...
      latitude:  27.0560097,
      longitude: 12.9,
      description: 'Outpatient routine diagnostic, therapeutic endoscopy and colonoscopy, advanced interventional endoscopic procedures',
    ),
    LocationItem(
      ...
      latitude:  27.0560097,
      longitude: 12.9,
      description: 'Outpatient by appointment only patient navigation, Oncology Counseling (emotional support), Financial counseling, External Beam Radiation Therapy, Intensity Modulated Radiation Therapy, Stereotactic Body Radiation Therapy, Image Guided Radiation Therapy, Stereotactic Radiosurgery',
    ),
    LocationItem(
      ...
      latitude: 27.0560097,
      longitude: 12.9,
      description: 'Inpatient & Outpatient Rehab Services, Comprehensive Stroke Rehabilitation, Neurological Rehabilitation, Neurological Rehabilitation, Orthopedic Rehabilitation, Cardiopulmonary Rehabilitation, Pet Therapy',
    ),
    LocationItem(
      ...
      latitude: 27.0560097,
      longitude: 12.9,
      description: 'Outpatient, appointment only Physicals, annual exams, adult vaccinations, care for chronic conditions (diabetes, high blood pressure, lupus, thyroid disease, pulmonary disease, care for acute illness (flu, pneumonia, ear, fungal infections), counseling regarding health & lifestyle concerns',
    ),
    LocationItem(
      ...
      latitude: 27.0560097,
      longitude: 12.9,
      description: 'Outpatient Walk-in Lab Testing, Breast Health Center & First Physicians Group offices.',
    ),
    LocationItem(
