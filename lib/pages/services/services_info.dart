...
class ServicesInfo {
  static List<ServiceItem> serviceitems = [
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Anticoagulation',
    ),
    ServiceItem(
      title: 'Bariatric Program',
      image: 'assets/images/bariatric.jpg',
      description:
      ...
      url: 'https://www.smh.com/Bariatric',
    ),
    ServiceItem(
      title: 'Behavioral Health',
      image: 'assets/images/Behavioral.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Behavioral-Health',
    ),
    ServiceItem(
      title: 'Cancer Institute',
      image: 'assets/images/Cancer-Care.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Cancer-Institute',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Cardiac-Services',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Clinical-Trials',
    ),
    ServiceItem(
        title: 'Critical Care',
        ...
        url: 'https://www.smh.com/Home/Services/Critical-Care'),
    ServiceItem(
      title: 'Community Specialty Clinic',
      image: 'assets/images/i7.jpeg',
      description:
      ...
      url: 'https://www.smh.com/communityspecialtyclinic',
    ),
    ServiceItem(
      title: 'Diabetes',
      ...
      url: 'https://www.smh.com/Home/Services/Diabetes',
    ),
    ServiceItem(
      title: 'Digestive Disorders',
      image: 'assets/images/Digestive-Disorders.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Digestive-Disorders',
    ),
    ServiceItem(
    ...
    ServiceItem(
      title: 'Genetic Counseling & Testing',
      image: 'assets/images/Genetic.jpg',
      description:
      ...
      url: 'https://www.smh.com/genes',
    ),
    ServiceItem(
      title: 'HealthLine Physician Referral',
      ...
      url: 'https://www.smh.com/Healthline',
    ),
    ServiceItem(
      title: 'Home Care',
      ...
      url: 'https://www.smh.com/Home/Services/Home-Care',
    ),
    ServiceItem(
      title: 'Hyperbaric Medicine',
      image: 'assets/images/Hyperbaric.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Hyperbaric-Medicine',
    ),
    ServiceItem(
      title: 'Infusion Therapy',
      image: 'assets/images/i16.jpeg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Infusion-Therapy',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/lab',
    ),
    ServiceItem(
      title: 'Maternity Services',
      image: 'assets/images/Maternity-Services.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Maternity-Services',
    ),
    ServiceItem(
      title: 'Memory Disorders',
      image: 'assets/images/i18.jpeg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Memory-Disorders',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Neurological-Care',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Nutrition',
    ),
    ServiceItem(
      title: 'Orthopedics',
      image: 'assets/images/Orthopedic.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Orthopedics',
    ),
    ServiceItem(
      title: 'Patient Financial Services',
      image: 'assets/images/i21.jpeg',
      description:
    ...
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Pediatrics',
    ),
    ServiceItem(
      title: 'Radiology/Imaging Services',
      image: 'assets/images/i25.jpeg',
      description:
      ...
      url: 'https://www.smh.com/diagnostics',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/rehab',
    ),
    ServiceItem(
      title: 'Respiratory Care',
      image: 'assets/images/Respiratory-Care.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Respiratory-Care',
    ),
    ServiceItem(
      title: 'Supportive Care Services',
      image: 'assets/images/Supportive-Care-Services.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Supportive-Care-Services',
    ),
    ServiceItem(
      title: 'Support Group Listings',
      image: 'assets/images/Support-Group-Listings.jpg',
      description:
      ...
      url: 'https://www.smh.com/Contact-Us/Support-Group-Listings',
    ),
    ServiceItem(
      title: 'Surgery',
      ...
      url: 'https://www.smh.com/Surgery',
    ),
    ServiceItem(
      title: 'Thoracic Surgery',
      image: 'assets/images/Thoracic-Surgery.jpg',
      description:
      ...
      url: 'https://www.smh.com/thoracic-surgery',
    ),
    ServiceItem(
      title: 'Urology',
      ...
      url: 'https://www.smh.com/Home/Services/Urology-Services',
    ),
    ServiceItem(
      title: 'Vascular Services',
      image: 'assets/images/Vascular-Services.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Services/Vascular-Services',
    ),
    ServiceItem(
      title: 'Visitor Food Services',
      image: 'assets/images/Visitor-Food-Services.jpg',
      description:
      ...
      url: 'https://www.smh.com/Home/Patients-Visitors/Visitor-Food-Services',
    ),
    ServiceItem(
      ...
      url: 'https://www.smh.com/Home/Services/Womens-Health-Services',
    ),
    ServiceItem(
      title: 'Wound Care',
